...
const translations = {
  en: {
    ...
    "chat.auth.title": "Sign in or create an account",
    "chat.auth.subtitle": "Identify yourself to start chatting with our support team.",
    "chat.auth.tabSignIn": "Sign in",
    "chat.auth.tabSignUp": "Create account",
    "chat.auth.name": "Full name",
    "chat.auth.email": "Email",
    "chat.auth.phone": "Phone (optional)",
    "chat.auth.password": "Password",
    "chat.auth.signIn": "Sign in",
    "chat.auth.signUp": "Create account",
    "chat.auth.signingIn": "Signing in...",
    "chat.auth.signingUp": "Creating account...",
    "chat.auth.invalidCredentials": "Invalid email or password.",
    "chat.auth.accountExists": "An account with this email already exists. Sign in instead.",
    "chat.auth.signInFailed": "Could not sign in. Please try again.",
    "chat.auth.signUpFailed": "Could not create the account. Please try again.",
    "chat.auth.confirmationRequired": "Almost done! Check your email to confirm your account, then sign in.",
    "chat.auth.resendConfirmation": "Resend confirmation email",
    "chat.auth.confirmationSent": "Confirmation email sent. Check your inbox.",
    "chat.auth.resendFailed": "Could not resend the confirmation email. Try again.",
    "chat.auth.signedInAs": "Signed in as",
  ...
  es: {
    ...
    "chat.auth.title": "Inicia sesión o crea una cuenta",
    "chat.auth.subtitle": "Identifícate para empezar a chatear con nuestro equipo de soporte.",
    "chat.auth.tabSignIn": "Iniciar sesión",
    "chat.auth.tabSignUp": "Crear cuenta",
    "chat.auth.name": "Nombre completo",
    "chat.auth.email": "Correo electrónico",
    "chat.auth.phone": "Teléfono (opcional)",
    "chat.auth.password": "Contraseña",
    "chat.auth.signIn": "Iniciar sesión",
    "chat.auth.signUp": "Crear cuenta",
    "chat.auth.signingIn": "Iniciando sesión...",
    "chat.auth.signingUp": "Creando cuenta...",
    "chat.auth.invalidCredentials": "Correo o contraseña inválidos.",
    "chat.auth.accountExists": "Ya existe una cuenta con este correo. Inicia sesión.",
    "chat.auth.signInFailed": "No se pudo iniciar sesión. Inténtalo de nuevo.",
    "chat.auth.signUpFailed": "No se pudo crear la cuenta. Inténtalo de nuevo.",
    "chat.auth.confirmationRequired": "¡Casi listo! Revisa tu correo para confirmar la cuenta y luego inicia sesión.",
    "chat.auth.resendConfirmation": "Reenviar correo de confirmación",
    "chat.auth.confirmationSent": "Correo de confirmación enviado. Revisa tu bandeja de entrada.",
    "chat.auth.resendFailed": "No se pudo reenviar el correo de confirmación. Inténtalo de nuevo.",
    "chat.auth.signedInAs": "Sesión iniciada como",
    "chat.auth.signOut": "Cerrar sesión",
